...
<!--- @@author: Trond Ulseth (trond@idl.no) --->
	...
	<cfproperty ftSeq="1" ftFieldset="Form field" ftLabel="Form field name" ftDisplayOnly="true" name="title" type="string" hint="Form Item title" required="yes" default="" />
	<cfproperty ftSeq="2" ftFieldset="Form field" ftLabel="Form field value" name="value" type="longchar" hint="Value of the form element" required="no" default="" />
