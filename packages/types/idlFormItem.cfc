<cfcomponent extends="farcry.core.packages.types.types" displayname="Form builder item" output="false">
	...
	<!--- type properties --->
	<cfproperty name="title" ftfieldset="General" type="string" hint="Form Item title" required="yes" default="" ftlabel="Label" ftseq="1">
	<cfproperty name="type" ftfieldset="General" type="string" hint="The type of Form Item"	default="textfield" fttype="list" ftlist="textfield:Text Field,textarea:Text Area,checkbox:Check Box,radiobutton:Radio Button,list:List,filefield:Attachment,statictext:Static Text,hidden:Hidden Field" ftlabel="Input type"  ftseq="2">
	<cfproperty name="initValue" ftfieldset="General" type="string" hint="Initial value of the form element" required="no" default="" ftlabel="Initial value" ftseq="3">
	<cfproperty name="name" ftfieldset="General" type="string" hint="name for grouping radiobuttons and check boxes" required="true" default="" ftlabel="Group name" ftseq="4">
